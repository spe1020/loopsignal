...
psql -v ON_ERROR_STOP=1 -d "$company_test_database" -f scripts/company/native-bootstrap.sql -f supabase/migrations/202609070001_company.sql -f supabase/migrations/202609070002_billing.sql >/dev/null
